...
namespace Practic5
{
    internal class Tortiki
    {
        ...
        public static Paragraph Circle              = new(250, "Круг");
        public static Paragraph Square              = new(360, "Квадрат");
        public static Paragraph Heart               = new(560, "Сердце");
        public static Paragraph Small               = new(434, "Маленький");
        public static Paragraph Middle              = new(323, "Средний");
        public static Paragraph Huge                = new(456, "Большой");
        public static Paragraph Chocolate           = new(567, "Шоколад");
        public static Paragraph Strawberry          = new(890, "Клубника");
        public static Paragraph Mango_guava         = new(967, "Манго-гуава");
        public static Paragraph Halfkg              = new(545, "500 грамм");
        public static Paragraph Kg                  = new(1012, "1 килограмм");
        public static Paragraph Kgg                 = new(1568, "1.5 килограмма");
        public static Paragraph Chocolate_g         = new(155, "Шоколад");
        public static Paragraph White_chocolate     = new(255, "Белый шоколад");
        public static Paragraph Caramel             = new(555, "Карамельный ганаш");
